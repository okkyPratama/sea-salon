      ...
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            <p className="text-[18px] font-medium text-white">
              <h1 className="text-white font-extrabold">
                <span className="text-cyan-600">SEA</span> Salon
              </h1>
            </p>
            <p className="mt-[18px] text-[15px] font-normal text-white/[80%] text-start">
              At SEA Salon, we redefine beauty and elegance through our
              exceptional services and unwavering commitment to our clients.
              With a team of highly skilled professionals and a luxurious
              ambiance, we provide a sanctuary where you can indulge in the
              latest hair trends, cutting-edge treatments, and unparalleled
              pampering.
            </p>
            <img
              alt="Company Logo"
          ...
          <div className="md:w-[316px]">
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a
                  href="https://api.whatsapp.com/send?phone=628164829372"
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-normal text-white md:text-[12px]">
            © Copyright 2024 All Rights Reserved by PT Salon Samudra Elok Abadi
            (SEA)
          </p>
        </div>
      </div>
