...
const NavLink: React.FC<NavLinkProps> = ({
  ...
  current = false,
    ...
    const activeClasses = "text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700";
    const inactiveClasses = "text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700";
  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="/src/assets/sea-salon-logo.png" className="h-8" alt="SEA Salon Logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap">SEA Salon</span>
      </a>
      <div className="flex md:order-2 items-center">
        {user ? (
          ...
          <button
            onClick={() => {/* Login */}}
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center w-full md:w-auto"
          >
            Login
          </button>
        )}
